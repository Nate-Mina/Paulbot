...
function ControlTray({ children }: ControlTrayProps) {
  ...
  useEffect(() => {
    ...
    if (connected && !muted && audioRecorder) {
      // Fix: Correctly call `on` method which is available on AudioRecorder as it extends EventEmitter.
    ...
    return () => {
      // Fix: Correctly call `off` method which is available on AudioRecorder as it extends EventEmitter.
