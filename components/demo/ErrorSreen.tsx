...
export default function ErrorScreen() {
  ...
  useEffect(() => {
    ...
    // Fix: Correctly call `on` method, which is available on GenAILiveClient as it extends EventEmitter.
    client.on('error', onError);

    return () => {
      // Fix: Correctly call `off` method, which is available on GenAILiveClient as it extends EventEmitter.
