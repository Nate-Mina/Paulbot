...
// Fix: Use ES module import syntax for eventemitter3.
...
// Fix: Add event type definitions for AudioRecorder.
    ...
    this.starting = new Promise(async (resolve, reject) => {
      ...
      this.recordingWorklet.port.onmessage = async (ev: MessageEvent) => {
        ...
        if (arrayBuffer) {
          ...
          // Fix: `emit` is available because this class extends EventEmitter.
